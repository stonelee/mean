...
module.exports = function(app) {
  ...
  app.get('/articles/my', articles.my);
  app.get('/articles/hot', articles.hot);
  app.get('/articles/tags', articles.tags);
  app.get('/articles/tags/:tag', articles.listByTag);
  ...
  app.get('/tags', articles.tags);
  app.get('/tags/:tag', articles.listByTag);
};
